# Windsurf × Prisma AIRS security hooks

Scan every checkpoint of **Windsurf** through Prisma AIRS — pick a runtime and drop
the matching `.windsurf/` folder into your project.
...
Each folder is self-contained (engine + wiring + this vendor's `.windsurf/`). Shared

# ClaudeCode × Prisma AIRS security hooks

Scan every checkpoint of **ClaudeCode** through Prisma AIRS — pick a runtime and drop
the matching `.claude/` folder into your project.
...
Each folder is self-contained (engine + wiring + this vendor's `.claude/`). Shared

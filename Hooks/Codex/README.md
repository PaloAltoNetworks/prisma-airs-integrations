# Codex × Prisma AIRS security hooks

Scan every checkpoint of **Codex** through Prisma AIRS — pick a runtime and drop
the matching `.codex/` folder into your project.
...
Each folder is self-contained (engine + wiring + this vendor's `.codex/`). Shared

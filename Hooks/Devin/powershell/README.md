...
**Drop-in Prisma AIRS security hooks for Devin, powershell runtime.**

<sub><a href="../README.md">← Devin overview</a> &nbsp;·&nbsp; <a href="../../README.md">all agents</a></sub>
...
> [!NOTE]
> The wiring in `.devin/hooks.v1.json` calls the engine with a **relative** path (`.devin/hooks/airs-hooks.ps1`), so it works as-is when the agent runs hooks from your project root — otherwise swap in an absolute path.
